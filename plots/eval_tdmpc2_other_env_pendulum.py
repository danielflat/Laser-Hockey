...
LUNAR_LANDER_TRAINING_STEPS = 2  # The number of training steps for the pendulum environment

EVAL_USE_ALGO = TDMPC2_ALGO
EVAL_SEEDS = [1000000, 2000000, 3000000]  # Set a test seed if you want to
EVAL_RENDER_MODE = None  # For whom do you want to render? None or HUMAN
...
def eval_tdmpc2_other_env():
    ...
    logging.info(f"Pendulum: {PENDULUM_TRAINING_STEPS} | Lunar Lander: {LUNAR_LANDER_TRAINING_STEPS}")
