...
from src.util.constants import ADAM, ADAMW, DQN, EXPONENTIAL, L1, LINEAR, PENDULUM, SMOOTHL1
...
OPTIONS = {
    ...
    "USE_CLIP_FOREACH": torch.cuda.is_available(),  # USE the foreach implementation of gradient clipping. Only relevant if 'USE_GRADIENT_CLIPPING' is True
}
HYPERPARAMS = {
    ...
    "DISCOUNT": 1.0,  # The discount factor for the TD error
    "EPSILON": 0.2,  # The initial exploration rate for the epsilon greedy algo
