...
SETTINGS = {
    ...
    "MAIN": {
        "SEED": 30,  # The seed that we want to use
        ...
        "USE_ALGO": TD3_ALGO,  # The used algorithm. Supported: DQN_ALGO, PPO_ALGO, TD3_ALGO
    ...
    "AGENT": {
        ...
        "OPT_ITER": 30,  # How many iterations should be done of gradient descent when calling agent.optimize()?
        "BATCH_SIZE": 100,  # The batch size for doing gradient descent
